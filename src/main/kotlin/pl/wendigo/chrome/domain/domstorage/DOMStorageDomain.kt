 ...
 */
@pl.wendigo.chrome.ProtocolExperimental class DOMStorageDomain internal constructor(private val connectionRemote : pl.wendigo.chrome.RemoteDebuggerConnection) {
