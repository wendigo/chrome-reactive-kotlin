 ...
 */
class DOMDomain internal constructor(private val connection : pl.wendigo.chrome.DebuggerConnection) {
   ...
   */
   fun documentUpdated() : io.reactivex.Flowable<pl.wendigo.chrome.DebuggerEvent> {
