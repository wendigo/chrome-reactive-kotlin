 ...
 */
@pl.wendigo.chrome.ProtocolExperimental class DatabaseDomain internal constructor(private val connectionRemote : pl.wendigo.chrome.RemoteDebuggerConnection) {
