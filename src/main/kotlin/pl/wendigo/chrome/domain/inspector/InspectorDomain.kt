 ...
 */
@pl.wendigo.chrome.ProtocolExperimental class InspectorDomain internal constructor(private val connectionRemote : pl.wendigo.chrome.RemoteDebuggerConnection) {
