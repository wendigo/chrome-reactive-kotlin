...
class ConsoleDomain internal constructor(connection: pl.wendigo.chrome.protocol.DebuggerWebSocketConnection) :
    ...
    fun clearMessages(): io.reactivex.rxjava3.core.Single<pl.wendigo.chrome.protocol.RequestResponseFrame> = connection.request("Console.clearMessages", null, pl.wendigo.chrome.protocol.RequestResponseFrame.serializer())
    ...
    fun disable(): io.reactivex.rxjava3.core.Single<pl.wendigo.chrome.protocol.RequestResponseFrame> = connection.request("Console.disable", null, pl.wendigo.chrome.protocol.RequestResponseFrame.serializer())
...
`messageAdded` notification.
    ...
    fun enable(): io.reactivex.rxjava3.core.Single<pl.wendigo.chrome.protocol.RequestResponseFrame> = connection.request("Console.enable", null, pl.wendigo.chrome.protocol.RequestResponseFrame.serializer())
