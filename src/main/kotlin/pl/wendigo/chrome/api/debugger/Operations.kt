...
class DebuggerOperations internal constructor(private val connection: pl.wendigo.chrome.protocol.ChromeDebuggerConnection) {
    ...
    fun enable(): io.reactivex.Single<pl.wendigo.chrome.protocol.ResponseFrame> {
        return connection.runAndCaptureResponse("Debugger.enable", null, pl.wendigo.chrome.protocol.ResponseFrame::class.java).map {
            it.value()
        }
    }
    ...
    fun disable(): io.reactivex.Single<pl.wendigo.chrome.protocol.ResponseFrame> {
        return connection.runAndCaptureResponse("Debugger.disable", null, pl.wendigo.chrome.protocol.ResponseFrame::class.java).map {
            it.value()
        }
    }
     ...
     */
    fun setBreakpointsActive(input: SetBreakpointsActiveRequest): io.reactivex.Single<pl.wendigo.chrome.protocol.ResponseFrame> {
        return connection.runAndCaptureResponse("Debugger.setBreakpointsActive", input, pl.wendigo.chrome.protocol.ResponseFrame::class.java).map {
            it.value()
        }
    }
     ...
     */
    fun setSkipAllPauses(input: SetSkipAllPausesRequest): io.reactivex.Single<pl.wendigo.chrome.protocol.ResponseFrame> {
        return connection.runAndCaptureResponse("Debugger.setSkipAllPauses", input, pl.wendigo.chrome.protocol.ResponseFrame::class.java).map {
            it.value()
        }
    }
    ...
    fun setBreakpointByUrl(input: SetBreakpointByUrlRequest): io.reactivex.Single<SetBreakpointByUrlResponse> {
        return connection.runAndCaptureResponse("Debugger.setBreakpointByUrl", input, SetBreakpointByUrlResponse::class.java).map {
            it.value()
        }
    }
    ...
    fun setBreakpoint(input: SetBreakpointRequest): io.reactivex.Single<SetBreakpointResponse> {
        return connection.runAndCaptureResponse("Debugger.setBreakpoint", input, SetBreakpointResponse::class.java).map {
            it.value()
        }
    }
     ...
     */
    fun removeBreakpoint(input: RemoveBreakpointRequest): io.reactivex.Single<pl.wendigo.chrome.protocol.ResponseFrame> {
        return connection.runAndCaptureResponse("Debugger.removeBreakpoint", input, pl.wendigo.chrome.protocol.ResponseFrame::class.java).map {
            it.value()
        }
    }
     ...
     */
    fun continueToLocation(input: ContinueToLocationRequest): io.reactivex.Single<pl.wendigo.chrome.protocol.ResponseFrame> {
        return connection.runAndCaptureResponse("Debugger.continueToLocation", input, pl.wendigo.chrome.protocol.ResponseFrame::class.java).map {
            it.value()
        }
    }
     ...
     */
    fun stepOver(): io.reactivex.Single<pl.wendigo.chrome.protocol.ResponseFrame> {
        return connection.runAndCaptureResponse("Debugger.stepOver", null, pl.wendigo.chrome.protocol.ResponseFrame::class.java).map {
            it.value()
        }
    }
     ...
     */
    fun stepInto(): io.reactivex.Single<pl.wendigo.chrome.protocol.ResponseFrame> {
        return connection.runAndCaptureResponse("Debugger.stepInto", null, pl.wendigo.chrome.protocol.ResponseFrame::class.java).map {
            it.value()
        }
    }
     ...
     */
    fun stepOut(): io.reactivex.Single<pl.wendigo.chrome.protocol.ResponseFrame> {
        return connection.runAndCaptureResponse("Debugger.stepOut", null, pl.wendigo.chrome.protocol.ResponseFrame::class.java).map {
            it.value()
        }
    }
     ...
     */
    fun pause(): io.reactivex.Single<pl.wendigo.chrome.protocol.ResponseFrame> {
        return connection.runAndCaptureResponse("Debugger.pause", null, pl.wendigo.chrome.protocol.ResponseFrame::class.java).map {
            it.value()
        }
    }
     ...
     */
    fun resume(): io.reactivex.Single<pl.wendigo.chrome.protocol.ResponseFrame> {
        return connection.runAndCaptureResponse("Debugger.resume", null, pl.wendigo.chrome.protocol.ResponseFrame::class.java).map {
            it.value()
        }
    }
    ...
    fun searchInContent(input: SearchInContentRequest): io.reactivex.Single<SearchInContentResponse> {
        return connection.runAndCaptureResponse("Debugger.searchInContent", input, SearchInContentResponse::class.java).map {
            it.value()
        }
    }
    ...
    fun setScriptSource(input: SetScriptSourceRequest): io.reactivex.Single<SetScriptSourceResponse> {
        return connection.runAndCaptureResponse("Debugger.setScriptSource", input, SetScriptSourceResponse::class.java).map {
            it.value()
        }
    }
    ...
    fun restartFrame(input: RestartFrameRequest): io.reactivex.Single<RestartFrameResponse> {
        return connection.runAndCaptureResponse("Debugger.restartFrame", input, RestartFrameResponse::class.java).map {
            it.value()
        }
    }
    ...
    fun getScriptSource(input: GetScriptSourceRequest): io.reactivex.Single<GetScriptSourceResponse> {
        return connection.runAndCaptureResponse("Debugger.getScriptSource", input, GetScriptSourceResponse::class.java).map {
            it.value()
        }
    }
     ...
     */
    fun setPauseOnExceptions(input: SetPauseOnExceptionsRequest): io.reactivex.Single<pl.wendigo.chrome.protocol.ResponseFrame> {
        return connection.runAndCaptureResponse("Debugger.setPauseOnExceptions", input, pl.wendigo.chrome.protocol.ResponseFrame::class.java).map {
            it.value()
        }
    }
    ...
    fun evaluateOnCallFrame(input: EvaluateOnCallFrameRequest): io.reactivex.Single<EvaluateOnCallFrameResponse> {
        return connection.runAndCaptureResponse("Debugger.evaluateOnCallFrame", input, EvaluateOnCallFrameResponse::class.java).map {
            it.value()
        }
    }
     ...
     */
    fun setVariableValue(input: SetVariableValueRequest): io.reactivex.Single<pl.wendigo.chrome.protocol.ResponseFrame> {
        return connection.runAndCaptureResponse("Debugger.setVariableValue", input, pl.wendigo.chrome.protocol.ResponseFrame::class.java).map {
            it.value()
        }
    }
     ...
     */
    fun setAsyncCallStackDepth(input: SetAsyncCallStackDepthRequest): io.reactivex.Single<pl.wendigo.chrome.protocol.ResponseFrame> {
        return connection.runAndCaptureResponse("Debugger.setAsyncCallStackDepth", input, pl.wendigo.chrome.protocol.ResponseFrame::class.java).map {
            it.value()
        }
    }
    ...
    @pl.wendigo.chrome.protocol.Experimental
    fun setBlackboxPatterns(input: SetBlackboxPatternsRequest): io.reactivex.Single<pl.wendigo.chrome.protocol.ResponseFrame> {
        return connection.runAndCaptureResponse("Debugger.setBlackboxPatterns", input, pl.wendigo.chrome.protocol.ResponseFrame::class.java).map {
            it.value()
        }
    }
    ...
    @pl.wendigo.chrome.protocol.Experimental
    fun setBlackboxedRanges(input: SetBlackboxedRangesRequest): io.reactivex.Single<pl.wendigo.chrome.protocol.ResponseFrame> {
        return connection.runAndCaptureResponse("Debugger.setBlackboxedRanges", input, pl.wendigo.chrome.protocol.ResponseFrame::class.java).map {
            it.value()
        }
    }
     ...
     */
    fun resumed(): io.reactivex.Flowable<pl.wendigo.chrome.protocol.Event> {
     ...
     * Fired when the virtual machine resumed execution.
     */
    fun resumedTimed(): io.reactivex.Flowable<io.reactivex.schedulers.Timed<pl.wendigo.chrome.protocol.Event>> {
        return connection.captureEvents("Debugger.resumed", pl.wendigo.chrome.protocol.Event::class.java)
    }
